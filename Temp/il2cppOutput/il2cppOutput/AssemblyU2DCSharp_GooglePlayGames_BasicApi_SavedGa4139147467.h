...
struct  ConflictResolutionStrategy_t4139147467 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConflictResolutionStrategy_t4139147467, ___value___1)); }
