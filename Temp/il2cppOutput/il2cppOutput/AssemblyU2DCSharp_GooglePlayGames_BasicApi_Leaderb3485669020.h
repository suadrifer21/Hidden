...
struct  LeaderboardTimeSpan_t3485669020 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LeaderboardTimeSpan_t3485669020, ___value___1)); }
