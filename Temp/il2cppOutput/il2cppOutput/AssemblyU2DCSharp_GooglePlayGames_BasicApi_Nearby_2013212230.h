...
struct  InitializationStatus_t2013212230 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(InitializationStatus_t2013212230, ___value___1)); }
